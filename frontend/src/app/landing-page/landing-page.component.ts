...
export class LandingPageComponent implements OnInit {
  ...
  constructor(
    ...
    private bookingBuilder: BookingBuilderService,
  ...
  displayFromStation(station: Station): string {
    return station && station.AdvertisedLocationName
  ...
  getDistanceAndCost() {
    ...
    let distance = Math.round(
      this.calculateDistance(fromYCoord, fromXCoord, toYCoord, toXCoord)
    );
